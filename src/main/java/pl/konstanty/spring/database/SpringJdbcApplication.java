...
//		logger.info("Number of persons created: " + String.valueOf(dao.insert(new Person("Stephany", "Berlin", new Date()))));
//		logger.info("Number of persons updated: " + String.valueOf(dao.update(new Person("Jacky", "Moscau", new Date()), 3)));
//
//		logger.info(String.valueOf(dao.findAll()));
//	}
//}
